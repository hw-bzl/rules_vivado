#!/usr/bin/env bash
# Build the rules_vivado release archive and emit release notes.
...
#
# Args:
#   $1: tag name (e.g. 0.1.1). Must match VERSION in version.bzl.
#
# Side effects:
#   Writes rules_vivado-${TAG}.tar.gz to the current directory. This
...
ARCHIVE="rules_vivado-${TAG}.tar.gz"
